...
public class Progressbar extends View {
     ...
     * 左侧已完成进度条的颜色
     */
    private int paintLeftColor = 0xffffffff;

    /**
     * 右侧未完成进度条的颜色
     */
    private int paintRightColor = 0x80999999;
    ...
    private void initData() {
        ...
        //设置进度条画笔的宽度
        int paintProgressWidthPx = ToolUtils.dip2px(context, paintProgressWidth);

        //设置百分比文字的尺寸
        int paintTextSizePx = ToolUtils.sp2px(context, paintTextSize);
