...
public class ClipDialog extends Dialog {
    ...
    public ClipDialog(Context context,String text, AnalysisUrlListener  analysisUrlListener) {
    ...
    private void initView(String text)  {
        View view = LayoutInflater.from(mContext).inflate(R.layout.dialog_clip, null);
        setContentView(view);
        setCancelable(false);
        TextView textinfo = view.findViewById(R.id.dialog_clip_text);
